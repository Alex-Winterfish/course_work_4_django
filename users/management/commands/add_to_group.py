...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        group.permissions.add(client_view_permission, mailing_view_permission,
                             message_view_permission, disable_permission, block_permission)
        user.groups.add(group)
        self.stdout.write(self.style.SUCCESS(f'Пользователь {user.username} добавлен в группу managers.'))